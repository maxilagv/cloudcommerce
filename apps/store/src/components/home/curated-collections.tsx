...
import { homeCollections } from "@/lib/home-data";
  ...
  return (
    <section aria-labelledby="home-collections-title" className="mt-8">
      <SectionHeading
        ...
        title="Compra por intencion, no por lista"
        description="Accesos editoriales para resolver necesidades concretas: jugar, trabajar o conectar tu casa."
      />
      <div className="grid gap-4 lg:grid-cols-3">
        {homeCollections.map(({ id, title, description, href, image, icon: Icon }) => (
          <Link
            key={id}
            href={href}
